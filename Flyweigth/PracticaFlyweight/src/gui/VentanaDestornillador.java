...
public class VentanaDestornillador extends JFrame implements ActionListener{
    ...
    private final JButton btnDesatornillar,btnCrearTornillo;
    ...
    public VentanaDestornillador(Destornillador destornillador){
        ...
        btnCrearTornillo = new JButton("Crear tornillo");
    ...
    public void initElements(){
        ...
        btnDesatornillar.setLocation(50, 350);
        ...
        btnCrearTornillo.setSize(new Dimension(150,35));
        btnCrearTornillo.setLocation(250, 350);
        btnCrearTornillo.setFont(new Font("Arial",Font.BOLD,15));
        btnCrearTornillo.setFocusable(false);
        btnCrearTornillo.addActionListener(this);
        add(btnCrearTornillo);
